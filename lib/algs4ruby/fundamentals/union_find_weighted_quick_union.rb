module Algs4Ruby
  ...
  #
  # This implementation makes use of union by rank to have both fast #find and
  # fast #union operations.
  # Initialization takes time proportional to the number of elements in the set.
  # The #find, #union and #connected? operations all take time logarithmically
  # proportional to the number of items in the set in the worst case. The
  #
  #
  ...
  #
  # Testing client:
  #   ruby union_find_weighted_quick_union.rb
  #   10
  #   1 2
  #   2 3
  #   5 6
  ...
  class UnionFindWeightedQuickUnion
    ...
    # Performance: time linearly proportional to n in the worst case.
    ...
    # index i.
    # Performance: worst case time logarithmically proportional to the number
  ...
  if __FILE__ == $PROGRAM_NAME
    n = gets.to_i
    uf = UnionFindWeightedQuickUnion.new(n)
...
###############################################################################
# The code in this file is based on the java code in WeightedQuickUnionUF from
...
# website as well.
#
# union_find_weighted_quick_union.rb is free software: you can redistribute it
# and/or modify it under the terms of the GNU General Public License as
# published by the Free Software Foundation, either version 3 of the License, or
# (at your option) any later version.
#
# union_find_weighted_quick_union.rb is distributed in the hope that it will be
# useful, but WITHOUT ANY WARRANTY; without even the implied warranty of
# MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE.  See the
# GNU General Public License for more details.
# You should have received a copy of the GNU General Public License
# along with union_find_weighted_quick_union.rb.  If not, see
